...
const HistoryFacilityReq = () => {
  ...
  let links = [
    {
      url: "/history/ticket/facility-req/detail/information",
      text: "Information",
    },

    { url: "/history/ticket/facility-req/detail/purchase", text: " Purchase" },
    {
      url: "/history/ticket/facility-req/detail/good-receive",
      text: "Goods Received",
    },
  ];
  ...
  switch (window.location.pathname) {
    case "/history/ticket/facility-req/detail/information":
      return (
        <>
          ...
          <BreadcrumbComponent
            Onclick={function () {
              ...
              window.location.href = `${origin}/history/facility-access`;
            }}
    ...
    case "/history/ticket/facility-req/detail/purchase":
      return (
        <>
          <div className={classes.toolbar} />
          <br />
    ...
    case "/history/ticket/facility-req/detail/good-receive":
      return (
        <>
          <div className={classes.toolbar} />
          <br />
...
export default HistoryFacilityReq;
