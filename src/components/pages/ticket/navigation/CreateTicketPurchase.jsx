...
const CreateTicketPurchase = ({ dataTicket }) => {
  ...
  const submitPR = async () => {
    ...
    if (dataReq[0].action_req_code === undefined) {
      ...
      const log_data = {
        request_number: dataReq[0].logs_id.request_number,
        user_name: dataReq[0].logs_id.user_name,
        user_email: dataReq[0].logs_id.user_email,
        user_area: dataReq[0].logs_id.user_area,
        ...
        leader_name: dataReq[0].logs_id.leader_name
          ? dataReq[0].logs_id.leader_name
          : null,
        leader_comment: dataReq[0].logs_id.leader_comment
          ? dataReq[0].logs_id.leader_comment
          : null,
        user_create: dataReq[0].logs_id.user_create,
        general_request: dataReq[0].logs_id.general_request,
        aplication_req: dataReq[0].logs_id.aplication_req,
